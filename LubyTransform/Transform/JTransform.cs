...
using System.Text;
// https://github.com/zemasa/4c54436f646573/tree/master/src
...
//	 */
//		public List<Block> encode(string msg)
//		{
//			if (msg == null) 
//			{
...
//			}
//
//			byte[] padded = pad (Encoding.ASCII.GetBytes (msg)); 
//
...
//	 */
//		public List<JBlock> encode(byte[][] inputBlock) 
//		{
//			if (inputBlock == null)
//			{
//				throw new ArgumentNullException ();
//			}
//
//			JBlock encodingBlock = null;
//			Random rGen1 = new Random ();
//			Random rGen2 = new Random ();
//			int seed;
//			int d=0, j;
//			List<JBlock> encMsg = new List<JBlock>();
//
//			do
//			{
//				seed = rGen1.Next (); 
...
//				encodingBlock = new JBlock(seed, d, blockSize);
//
//				for(int x=1; x<=d; x++)
//				{
